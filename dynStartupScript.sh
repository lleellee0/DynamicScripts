...
myScrapeAddress=D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H
...
do
    ...
    in
        ...
        h)
            ...
            echo " -s Scrape address requires an attribute Ex.  -s D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H"
			...
			echo "sudo sh $0 -s D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H"
			echo ""
			echo "Example 2: Setup a remote dynode"
			echo "sudo sh $0 -s D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H -d ReplaceMeWithOutputFrom_dynamic-cli_dynode_genkey"
			echo ""
			...
			echo "sudo sh $0 -s D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H -c false"			
			echo ""
			echo "Example 4: Turn off auto update on a dynode, you will be required to manually update if a new version comes along"
			echo "sudo sh $0 -s D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H -d ReplaceMeWithOutputFrom_dynamic-cli_dynode_genkey -a false"
			echo ""			
			echo "sudo sh Example 5: Setup a miner that donates to the author's address D7Vfm4upip3LZaHQisYPAhWxg8GqfaNp5H"
			echo "$0"
			echo ""			
